...
export function getDepth(params: {
  ...
  return service.get('/api/binance/api/v3/depth', { params })
}
...
export function getTrades(params: {
  ...
  return service.get('/api/binance/api/v3/trades', { params })
}
...
export function getTicker24hr(params: {
  ...
  return service.get('/api/binance/api/v3/ticker/24hr', { params })
}
